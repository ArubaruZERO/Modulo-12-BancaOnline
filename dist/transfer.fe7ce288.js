...
var validationSchema = {
  field: {
    account: [_fonk.Validators.required],
    iban: [{
      validator: _fonk.Validators.pattern,
      customArgs: {
        pattern: /([ES]{2}\d{2})(\d{4})(\d{4})(\d{2})(\d{10})/
      }
    }],
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js"}],"pages/transfer/transfer.helpers.js":[function(require,module,exports) {
"use strict";
...
var getAccountList = function getAccountList() {
  return _axios.default.get(urlAccount).then(function (response) {
    return response.data;
  });
};
...
var mapTransferFromViewModelToApi = function mapTransferFromViewModelToApi(transfer) {
  ...
  }, _defineProperty(_ref, "year", transfer.year), _defineProperty(_ref, "date", transfer.date), _defineProperty(_ref, "email", transfer.email), _ref;
};
...
(0, _transfer2.getAccountList)().then(function (apiAccount) {
...
(0, _helpers.onUpdateField)("select-account", function (event) {
  ...
  _transferValidations.formValidation.validateField("select-account", transfer.account).then(function (result) {
...
(0, _helpers.onUpdateField)("iban", function (event) {
  ...
  _transferValidations.formValidation.validateField("iban", transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)("name", function (event) {
  ...
  _transferValidations.formValidation.validateField("name", transfer.name).then(function (result) {
...
(0, _helpers.onUpdateField)("amount", function (event) {
  ...
  _transferValidations.formValidation.validateField("amount", transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)("concept", function (event) {
  ...
  _transferValidations.formValidation.validateField("concept", transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)("notes", function (event) {
  ...
  _transferValidations.formValidation.validateField("notes", transfer.notes).then(function (result) {
...
(0, _helpers.onUpdateField)("day", function (event) {
  ...
  _transferValidations.formValidation.validateField("day", transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)("month", function (event) {
  ...
  _transferValidations.formValidation.validateField("month", transfer.month).then(function (result) {
...
(0, _helpers.onUpdateField)("year", function (event) {
  ...
  _transferValidations.formValidation.validateField("year", transfer.year).then(function (result) {
...
(0, _helpers.onUpdateField)("email", function (event) {
  ...
  _transferValidations.formValidation.validateField("email", transfer.email).then(function (result) {
...
var onTransfer = function onTransfer() {
  ...
  return (0, _transfer2.insertTransfer)(apiTransfer);
...
(0, _helpers.onSubmitForm)("transfer-button", function () {
  _transferValidations.formValidation.validateForm(transfer).then(function (result) {
...
},{"../../common/helpers":"common/helpers/index.js","./transfer-validations":"pages/transfer/transfer-validations.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../core/router":"core/router/index.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.mapper":"pages/transfer/transfer.mapper.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
